...
// DB-only fields not needed for display
const DB_DEFAULTS = { _id: '', inventory: 0, isActive: true, createdAt: '' };
...
const SHIPPING_RETURNS_MODAL = `We ship across India via our trusted brand partners, offering premium white glove delivery.<br><br>Shipping costs are calculated at checkout based on your location. Standard delivery: 5–7 business days. Expedited: 2–3 business days to major cities.<br><br>Returns accepted within 14 days of delivery, provided the item is in its original condition with all labels and packaging intact.<br><br>Custom or bespoke items are not eligible for return.<br><br><a href='/return-policy' style='color: #111; text-decoration: underline; letter-spacing: 1px; font-size: 11px; text-transform: uppercase;'>Read our shipping & returns policy →</a>`;
const SHIPPING_RETURNS_BODY = `We ship across India via our trusted brand partners. Shipping costs are calculated at checkout based on your location. Returns accepted within 14 days of delivery in original condition.`;

const _fallbackProducts: Omit<Product, '_id' | 'inventory' | 'isActive' | 'createdAt'>[] = [
  {
    slug: 'trolly-bag',
    ...
    specs: [
      ...
      { key: 'COMPATIBLE ATTACHMENTS', value: 'Structure Sling. Core Pack. Utility Flask. Weather Module. Field Frame.', modalContent: `<a href="/products/side-bag" style="${L}">Structure Sling</a><a href="/products/bag-pack" style="${L}">Core Pack</a><a href="/products/water-bottle-s" style="${L}">Utility Flask</a><a href="/products/umbrella" style="${L}">Weather Module</a><a href="/products/sunglass" style="${L}">Field Frame</a>` },
      { key: 'SHIPPING & RETURNS', value: SHIPPING_RETURNS_BODY, modalContent: SHIPPING_RETURNS_MODAL },
    ],
    keyElements: [
      { tag: 'Feature 01', title: 'URNIETA Modular Attachment System', description: 'Integrated attachment panel on the exterior enables the Structure Sling, Utility Flask, Field Frame, and Weather Module to mount directly onto the case.', images: ['/asset/images/key-elements/trolly-bag-small/card1/k1.jpg', '/asset/images/key-elements/trolly-bag-small/card1/k2.jpg'] },
      { tag: 'Feature 02', title: 'TSA-Approved Locking System', description: 'Built-in TSA lock allows security screening without damage. Accepts standard TSA master keys used globally.', images: ['/asset/images/key-elements/trolly-bag-small/card2/k1.jpeg'] },
      { tag: 'Feature 03', title: '360° Spinner Wheels', description: 'Four multi-directional wheels distribute weight and allow full-rotation movement across all surface types.', images: ['/asset/images/key-elements/trolly-bag-small/card3/k1.jpeg', '/asset/images/key-elements/trolly-bag-small/card2/k2.jpeg'] },
      { tag: 'Feature 04', title: 'Expandable Internal Layout', description: 'Internal packing system with compression straps and expandable divider configuration for structured load management.', images: ['/asset/images/key-elements/trolly-bag-small/card4/k1.jpg'] },
    ],
  },
  {
    slug: 'trolly-bag-pro',
    ...
    keyElements: [
      { tag: 'Feature 01', title: 'URNIETA Modular Attachment System', description: 'Full-size exterior attachment panel for mounting Nofoal system accessories during transit.', images: ['/asset/images/key-elements/trolly-bag-big/card1/k1.jpg', '/asset/images/key-elements/trolly-bag-big/card1/k2.jpg'] },
      { tag: 'Feature 02', title: 'Expanded Internal Volume', description: '27-inch body with full-trip capacity. Expandable compression layout for extended journeys.', images: ['/asset/images/key-elements/trolly-bag-big/card2/k1.jpeg', '/asset/images/key-elements/trolly-bag-big/card2/k2.jpeg'] },
      { tag: 'Feature 03', title: '360° Spinner Mobility', description: 'Four-wheel spinner system for effortless directional movement across terminal and transit surfaces.', images: ['/asset/images/key-elements/trolly-bag-big/card3/k1.jpeg'] },
    ],
  },
  {
    slug: 'water-bottle-s',
    ...
    keyElements: [
      { tag: 'Feature 01', title: 'URNIETA Attachment Collar', description: 'Hypalon collar system allows the flask to mount directly to the Structure Sling, Core Pack, or Rigid Transit exterior panels.', images: ['/asset/images/key-elements/bottle-s/small bottel attachement1.jpeg', '/asset/images/key-elements/bottle-s/small bottel attachement2.jpg'] },
      { tag: 'Feature 02', title: 'Double-Wall Vacuum Insulation', description: 'Grade 316 stainless steel with vacuum insulation maintains temperature for extended periods in all environments.', images: ['/asset/images/key-elements/bottle-s/DSC08985.jpg'] },
      { tag: 'Feature 03', title: 'Compact 560ml Form', description: 'Sized for daily carry and system integration without adding unnecessary bulk to your configuration.', images: ['/asset/images/key-elements/bottle-s/small bottel attachement3.jpg'] },
    ],
  },
  {
    slug: 'water-bottle-b',
    ...
    keyElements: [
      { tag: 'Feature 01', title: '1500ml Extended Capacity', description: 'Full-day hydration in a single unit. Designed for field use, extended outdoor movement, and high-output activity.', images: ['/asset/images/key-elements/bottle-b/card1/k1.jpg'] },
      { tag: 'Feature 02', title: 'Dual-Access Lid System', description: 'Wide-mouth and flow-access lid configuration allows direct pour and controlled sip from the same unit.', images: ['/asset/images/key-elements/bottle-b/card2/k1.jpg', '/asset/images/key-elements/bottle-b/card2/k2.jpg'] },
      { tag: 'Feature 03', title: 'Reinforced Carry Handle', description: 'Integrated stainless handle rated for single-hand transport with full load.', images: ['/asset/images/key-elements/bottle-b/card3/k1.jpg'] },
    ],
  },
  {
    slug: 'umbrella',
    ...
    keyElements: [
      ...
      { tag: 'Feature 02', title: 'Carbon Fiber Frame', description: 'Lightweight carbon structure resists wind deformation without adding weight to your carry configuration.', images: ['/asset/images/products/umbrella/umbrella-2.jpg'] },
      { tag: 'Feature 03', title: 'Auto-Open / Auto-Close', description: 'Single-button operation for immediate deployment and collapse without interrupting movement.', images: ['/asset/images/products/umbrella/umbrella-3.jpg'] },
    ],
  },
  {
    slug: 'sunglass',
    ...
    keyElements: [
      { tag: 'Feature 01', title: 'URNIETA Mount Compatibility', description: 'Temple attachment points allow the Field Frame to clip directly onto the Structure Sling or Core Pack for hands-free carry.', images: ['/asset/images/key-elements/field-frame/card1/k1.jpeg', '/asset/images/key-elements/field-frame/card1/k2.jpg'] },
      { tag: 'Feature 02', title: 'Polarized UV400 Lens', description: 'Polycarbonate polarized lens blocks 100% UV and eliminates surface glare for clear visual performance in all light conditions.', images: ['/asset/images/key-elements/field-frame/card2/k1.jpeg', '/asset/images/key-elements/field-frame/card2/k2.jpg'] },
      { tag: 'Feature 03', title: 'TR-90 Flexible Frame', description: '28g wraparound TR-90 frame with sweat resistance and impact rating for active, outdoor, and transit use.', images: ['/asset/images/key-elements/field-frame/card3/k1.jpg'] },
    ],
  },
  {
    slug: 'side-bag',
    ...
    keyElements: [
      { tag: 'Feature 01', title: 'URNIETA System Compatibility', description: 'Allows sunglasses, utility flask 560, field module to be securely attached to the sling for quick access during movement.', images: ['/asset/images/key-elements/side-bag/card2/k1.jpg', '/asset/images/key-elements/side-bag/card2/k2.jpg'] },
      { tag: 'Feature 02', title: 'Dual Carry Configuration', description: 'Equipped with an adjustable crossbody strap and top carry handle, allowing flexible carry depending on movement and use.', images: ['/asset/images/key-elements/side-bag/card4/k1.jpeg'] },
      { tag: 'Feature 03', title: 'Expandable Storage System', description: 'Integrated expandable compartment system adapts to different carry needs without compromising the compact structure.', images: ['/asset/images/products/side-bag/side-bag-3.jpg'] },
      { tag: 'Feature 04', title: 'Water-Resistant Construction', description: 'Features water-resistant zippers and reinforced exterior hardware to protect contents during everyday movement and changing environments.', images: ['/asset/images/products/side-bag/side-bag-4.jpg'] },
    ],
  },
  {
    slug: 'bag-pack',
    ...
    specs: [
      ...
      { key: 'COMPATIBLE ATTACHMENTS', value: 'Structure Sling. Utility Flask 560. Weather Module. Field Frame. Field Module.', modalContent: `<a href="/products/side-bag" style="${L}">Structure Sling</a><a href="/products/water-bottle-s" style="${L}">Utility Flask 560</a><a href="/products/umbrella" style="${L}">Weather Module</a><a href="/products/sunglass" style="${L}">Field Frame</a><a href="/products/go-pro" style="${L}">Field Module</a>` },
      { key: 'SHIPPING & RETURNS', value: SHIPPING_RETURNS_BODY, modalContent: SHIPPING_RETURNS_MODAL },
    ],
    keyElements: [
      { tag: 'Feature 01', title: 'URNIETA Attachment System', description: 'Exterior panel system compatible with all URNIETA accessories — mount the Utility Flask, Field Frame, or Weather Module for full system carry.', images: ['/asset/images/key-elements/core-pack/card1/k1.jpg', '/asset/images/key-elements/core-pack/card1/k2.jpg'] },
      { tag: 'Feature 02', title: '35L Structured Capacity', description: 'Five-compartment internal layout with compression system. Rated for loads up to 50 lbs on reinforced shoulder straps.', images: ['/asset/images/key-elements/core-pack/card2/k1.jpg', '/asset/images/key-elements/core-pack/card2/k2.jpg'] },
      { tag: 'Feature 03', title: 'Detachable Section System', description: 'Modular detachment points allow reconfiguration of carry volume depending on mission requirements.', images: ['/asset/images/key-elements/core-pack/card5/k1.jpeg', '/asset/images/key-elements/core-pack/card5/k2.jpg'] },
      { tag: 'Feature 04', title: 'Water-Resistant Construction', description: 'X-PAC panels and water-resistant zippers protect contents across urban, field, and transit environments.', images: ['/asset/images/key-elements/core-pack/card1/k3.jpg'] },
    ],
  },
  {
    slug: 'go-pro',
    ...
    keyElements: [
      { tag: 'Feature 01', title: 'URNIETA Magnetic Mount', description: 'Magnetic base system mounts the Field Case to any URNIETA attachment point on the Structure Sling, Core Pack, or Rigid Transit.', images: ['/asset/images/key-elements/field-case/card1/k1.jpg', '/asset/images/key-elements/field-case/card1/k2.jpg'] },
      { tag: 'Feature 02', title: 'GoPro HERO Compatible', description: 'Precision-fit housing designed for HERO 9, 10, 11, and 12 with direct access to all controls and ports.', images: ['/asset/images/key-elements/field-case/card2/k1.jpeg', '/asset/images/key-elements/field-case/card2/k2.jpg'] },
      { tag: 'Feature 03', title: 'Impact-Rated Protection', description: 'Polycarbonate shell with impact-absorbing inner foam maintains camera function after drops and field impacts.', images: ['/asset/images/key-elements/field-case/card3/k1.jpg'] },
    ],
  },
];

export const fallbackProducts: Product[] = _fallbackProducts.map((p) => ({ ...DB_DEFAULTS, ...p }));
